		...
		<div id="pitch">
			...
			<tr>
				...
				<c:set var="pageNo" value="${ empty param.pageNo ? '1' : param.pageNo }" />
					<a href="listNotice.jb?pageNo=${ pageNo }">[목록]</a>
					<c:if test="${ authUser.id == noticeData.notice.writer.id }">
					<a href="modifyNotice.jb?no=${ noticeData.notice.number }">[게시글 수정]</a>
					<a href="deleteNotice.jb?no=${ noticeData.notice.number }">[게시글 삭제]</a>
					</c:if>
				</td>
			</tr>
			</table>
