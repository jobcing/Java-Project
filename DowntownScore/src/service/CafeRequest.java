...
public class CafeRequest {
	...
	public CafeRequest(String station, Integer score, String name, String comment, String member_nickname){
	...
	// Handler에서 생성한 Map 객체를 인자로 받아서 checkEmpty 한다.
